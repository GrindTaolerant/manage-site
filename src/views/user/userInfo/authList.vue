<template>
    <div class="app-container">
        ...
        stripe
            ...
            <el-table-column prop="certificatesType" label="ID Type"/>
            <el-table-column prop="certificatesNo" label="ID number"/>
            ...
            <el-table-column label="Action" width="250" align="center">
                <template slot-scope="scope">
                    ...
                    <el-button style="margin:10px" type="primary" size="mini" @click="approval(scope.row.id, 2)">Pass</el-button>
                    <el-button type="danger" size="mini" @click="approval(scope.row.id, -1)">Failed</el-button>

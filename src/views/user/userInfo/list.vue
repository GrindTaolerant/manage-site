<template>
    <div class="app-container">
        ...
        <el-form  :inline="true" class="demo-form-inline">
            <el-form-item>
                <el-input v-model="searchObj.keyword" placeholder="Name/Email"/>
            </el-form-item>
        ...
        stripe
            ...
            <el-table-column label="Status" prop="param.statusString" />
            <el-table-column label="Auth Status" prop="param.authStatusString"/>
            ...
            <el-table-column label="Action" width="200" align="center">
                ...
                <template slot-scope="scope">
                    <router-link :to="'/user/userInfo/show/'+scope.row.id">
                        <el-button style="margin:10px;" type="primary" size="mini">Display</el-button>
                    </router-link>


                    <el-button v-if="scope.row.status == 1" type="primary" size="mini" @click="lock(scope.row.id, 0)">Lock</el-button>
                    <el-button v-if="scope.row.status == 0" type="danger" size="mini" @click="lock(scope.row.id, 1)">Unlock</el-button>
                </template>

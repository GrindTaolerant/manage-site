...
export const constantRoutes = [
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: 'Hospital Setting Add', icon: 'tree' }
      },
      {
        path: 'edit/:id',
        name: 'Hospital Set Edit',
        component: () => import('@/views/hospitalset/add'),
        meta: { title: 'Hospital Setting Edit', noCache: true },
        hidden: true
      },
      {
        path: 'hospital/list',
      ...
      },
      {
        ...
        meta: { title: 'Display', noCache: true },
        hidden: true
      },
      {
...

  {
    ...
    children: [
...

      {
        ...
        meta: { title: 'Auth List', icon: 'table' }
      }
...

  {
    ...
    name: 'BasesInfo',
    meta: { title: 'Stats Management', icon: 'table' },
    alwaysShow: true,
    children: [
        {
          path: 'order/index',
